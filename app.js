...
// TODAY TAB functions (initToday, lockToday, gateHabit, valArt, gym listener) moved to today.js
...
// saveT3Intentions and loadT3Intentions are now in today.js (chip-based)

// updRC() and sealDay() moved to today.js
}
